...
export const products = [
  ...
  {
    id: 'brahma-chick-1week',
    name: 'Brahma Chicks — 1 Week Old (Pair)',
    price: 1200,
    description:
      'A pair of healthy 1-week-old Brahma chicks. Brahmas are one of the largest and most sought-after chicken breeds, known for their calm temperament, rich meat, and good egg production. Sold in pairs only.',
    ...
    tips: [
      ...
      'Provide clean fresh water at all times — use shallow dishes',
